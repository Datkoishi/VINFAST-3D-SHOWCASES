...
function Model({
  ...
  useEffect(() => {
    if (activeView === "exterior") {
      setHotspots([
        { position: [0.8, 0.5, 1.8], title: "Đèn pha", description: "Đèn pha LED tự động với thiết kế hiện đại" },
        { position: [-0.8, 0.5, 1.8], title: "Lưới tản nhiệt", description: "Lưới tản nhiệt đặc trưng của VinFast" },
        { position: [1.2, 0.3, 0], title: "Mâm xe", description: "Mâm hợp kim 19 inch với thiết kế thể thao" },
        { position: [0, 0.7, -1.8], title: "Đèn hậu", description: "Cụm đèn hậu LED với hiệu ứng 3D" },
      ])
      ...
      setHotspots([
        ...
        { position: [-0.3, 0.4, 0], title: "Ghế ngồi", description: "Ghế da cao cấp với chức năng chỉnh điện" },
        { position: [0, 1.0, -0.3], title: "Cửa sổ trời", description: "Cửa sổ trời toàn cảnh với rèm che tự động" },
      ])
    } else if (activeView === "engine") {
      setHotspots([
        { position: [0, 0.4, 0.5], title: "Động cơ", description: "Động cơ 2.0L Turbo với công suất 228 mã lực" },
        { position: [0.5, 0.4, 0.3], title: "Hệ thống làm mát", description: "Hệ thống làm mát hiệu suất cao" },
        { position: [-0.5, 0.4, 0.3], title: "Ắc quy", description: "Ắc quy dung lượng cao với tuổi thọ bền bỉ" },
        { position: [0, 0.4, -0.3], title: "Hộp số", description: "Hộp số tự động 8 cấp mượt mà" },
      ])
    }
  }, [activeView])
      ...
      {showHotspots &&
        hotspots.map((hotspot, index) => (
          <group key={index} position={hotspot.position}>
            {/* Điểm đỏ chính */}
            <mesh onClick={() => setActiveHotspot(index === activeHotspot ? null : index)}>
